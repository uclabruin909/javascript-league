...
var stepModule = (function() {
    ...
    function step2() {
        var stepCodeTxt = $('.stepCodeTxt');
        var selected = $('.selected');
        var newRating = $('#rangeWarning').text() + '%';
        var newBgColor = $('.backgroundInput').val();

        function setNewTxt() {
            var currentTxt = stepCodeTxt.html();

            var newTxt = currentTxt + '.style.background = ' + newBgColor + ';' + '</br>';
                newTxt += currentTxt + '.style.width = ' + newRating + ';';
